...
const routes = [
  ...
  },
  {
    ...
    component: () => import("@/views/v2/votes/IndexVoteInternational.vue"),
  },
  {
    path: "/bureaux-vote",
    name: "bureaux-vote",
    component: () => import("@/views/v2/votes/BureauVote.vue"),
  },
  ...
  },
  {
    path: "/centre-votes",
    name: "centre-votes",
    component: () => import("@/views/v2/controlers/CentreVotes.vue"),
  },
  {
    path: "/suivi",
    name: "suivi",
    component: () => import("@/views/v2/accueil/SuiviView.vue"),
  },
];
