    ...
    <form @submit.prevent="createLine()">
      ...
      <div class="form-row">
        ...
        <div class="form-group col-6">
          ...
          <input type="text" v-model="form.zone" class="form-control" >
        </div>
        <div class="form-group col-6">
          <label>Total enregistré<span class="text-danger">*</span></label>
          <input type="number" v-model="form.total_registered" class="form-control" >
        </div>
        <!-- <div class="form-group col-6">
          <label>Total bureau<span class="text-danger">*</span></label>
          <input type="number" v-model="form.total_offices" class="form-control" >
        </div> -->
        <div class="form-group col-6">
          <label>Total scrutin<span class="text-danger">*</span></label>
          <input type="number" v-model="form.total_scrutin" class="form-control" >
        </div>

        <div class="form-group col-6">
          <label>Nombre de bulletin blanc<span class="text-danger">*</span></label>
          <input type="number" v-model="form.nb_bulletin_blanc" class="form-control" >
        </div>
        <div class="form-group col-6">
          <label>Nombre de bulletin nule<span class="text-danger">*</span></label>
          <input type="number" v-model="form.nb_abstention" class="form-control" >
        </div>
        <div class="form-group col-6">
          <label>Nombre de scrutin validé<span class="text-danger">*</span></label>
          <input type="number" v-model="form.nb_scrutin_valide" class="form-control" >
        </div>
        <div class="form-group col-6">
          <label>Candidat 1<span class="text-danger">*</span></label>
          <input type="number" v-model="form.candidate_1" class="form-control" >
        </div>
        <div class="form-group col-6">
          <label>Camdidat 2<span class="text-danger">*</span></label>
          <input type="number" v-model="form.candidate_2" class="form-control" >
        </div>
        <div class="form-group col-6">
          <label>Candidat 3<span class="text-danger">*</span></label>
          <input type="number" v-model="form.candidate_3" class="form-control" >
        </div>
        <div class="form-group col-6">
          <label>Candidat 4<span class="text-danger">*</span></label>
          <input type="number" v-model="form.candidate_4" class="form-control" >
        </div>
        <div class="form-group col-6">
          <label>Candidat 5<span class="text-danger">*</span></label>
          <input type="number" v-model="form.candidate_5" class="form-control" >
        </div>
        <div class="form-group col-6">
          <label>Candidat 6<span class="text-danger">*</span></label>
          <input type="number" v-model="form.candidate_6" class="form-control" >
        </div>
        <div class="form-group col-6">
          <label>Latitude<span class="text-danger">*</span></label>
          <input type="number" v-model="form.lat" class="form-control" >
        </div>
        <div class="form-group col-6">
          <label>Longitude<span class="text-danger">*</span></label>
          <input type="number" v-model="form.lon" class="form-control" >
        </div>
        <div class="form-group col-6">
          <label>Code Bureau<span class="text-danger">*</span></label>
          <input type="number" v-model="form.burreau_code" class="form-control" >
        </div>
  ...
  data() {
    return {
      ...
      form: {
        ...
        lat: this.dialogRef.data.lat,
        lon: this.dialogRef.data.lon,
        burreau_code: this.dialogRef.data.burreau_code,
